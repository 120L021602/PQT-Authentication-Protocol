...
main()
{
    ...
    int                 count;
    int                 done;
    uint8_t             pk[CRYPTO_PUBLICKEYBYTES_SIG], sk[CRYPTO_SECRETKEYBYTES_SIG];
    int                 ret_val;
    ...
    do {
        ...
        m1 = (uint8_t *)calloc(mlen+CRYPTO_BYTES_SIG, sizeof(uint8_t));
        sm = (uint8_t *)calloc(mlen+CRYPTO_BYTES_SIG, sizeof(uint8_t));
        ...
        fprintBstr(fp_rsp, "pk = ", pk, CRYPTO_PUBLICKEYBYTES_SIG);
        fprintBstr(fp_rsp, "sk = ", sk, CRYPTO_SECRETKEYBYTES_SIG);
