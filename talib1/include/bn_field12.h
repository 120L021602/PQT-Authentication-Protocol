...
void  F12_GFrobenius(BNField12 *p, BNField12 b, int e); //十二次扩域元素的广义Frobenius值；
...
void F12_toString_d(BNField12 b, uint32_t system); // 以一般形式显示十二次扩域元素

void F12_toString(BNField12 b, uint32_t system); //根据SM9标准，以十六进或十进制显示十二次扩域元素
